package com.cis.inventory.book.config;
...
import com.cis.inventory.book.security.JwtAuthenticationEntryPoint;
import com.cis.inventory.book.security.JwtAuthenticationProvider;
import com.cis.inventory.book.security.JwtAuthenticationTokenFilter;
import com.cis.inventory.book.security.JwtSuccessHandler;
...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	*/
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable().authorizeRequests().antMatchers(HttpMethod.OPTIONS,"**/rest/**").permitAll().antMatchers(HttpMethod.GET,"**/rest/**").authenticated()
		.antMatchers(HttpMethod.POST,"**/rest/**").authenticated().antMatchers(HttpMethod.PUT,"**/rest/**").authenticated()
		.antMatchers(HttpMethod.DELETE,"**/rest/**").authenticated().and().exceptionHandling()
